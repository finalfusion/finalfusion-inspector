...
class Ui_InspectorWindow(object):
    def setupUi(self, InspectorWindow):
        ...
        self.metadataAction = QtWidgets.QAction(InspectorWindow)
        self.metadataAction.setObjectName("metadataAction")
        self.menuFile.addAction(self.openAction)
        self.menuFile.addAction(self.metadataAction)
    ...
    def retranslateUi(self, InspectorWindow):
        ...
        self.metadataAction.setText(_translate("InspectorWindow", "Metadata…"))
